...
function child_scripts(){
	...
	wp_enqueue_script('rightshow', 					$stylesheet_dir . '/js/rightshow.js');
	wp_enqueue_script('righthide', 					$stylesheet_dir . '/js/righthide.js');
...
<style>
.button {
    background: #85729F !important;
    border-color: #85729F !important;
    -webkit-box-shadow: 0 1px 0 #424358 !important;
    box-shadow: 0 1px 0 #424358 !important;
    color: #fff;
    text-decoration: none;
    text-shadow: 0 -1px 1px #85729F, 1px 0 1px #85729F, 0 1px 1px #85729F, -1px 0 1px #85729F !important;
}

.button:hover {
	background: #424358 !important;
    text-shadow: 0 -1px 1px #424358, 1px 0 1px #424358, 0 1px 1px #424358, -1px 0 1px #424358 !important;
}
</style>
    <?php
});
